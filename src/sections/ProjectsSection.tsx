...
export default function ProjectsSection() {
  ...
  const projects = [
    { title: "마비노기 Open Api 웹페이지", desc: "인게임 내 경매장, 전체 채팅, NPC 아이템 정보 확인 페이지", img: "/public/img/mabinogiApi.jpg", link: "https://soapy-ixora-d44.notion.site/Mabinogi-Api-1d64ddded97d8039a863f8abb0b58fb4" },
    { title: "더리워드 App", desc: "더리워드 App UI 디자인", img:"/public/img/theReword.png", link: "https://soapy-ixora-d44.notion.site/APP-1d64ddded97d80c5a50acad3499a5dae?pvs=73" },
    { title: "GLOX 브랜드 페이지", desc: "자전거 캐리어 제품 웹페이지", img: "/public/img/meta-glox.png", link: "https://soapy-ixora-d44.notion.site/GLOX-1d64ddded97d8057bf53cef6eb87a506" },
    { title: "Metainnovation Robot", desc: "메타이노베이션 서빙로봇 웹페이지", img: "/public/img/meta-robot.png", link: "https://soapy-ixora-d44.notion.site/Metainnovation-Robot-1d64ddded97d80e2bce1d14d057a752c" },
  ...
  return (
    <section
      id="projects"
      ref={sectionRef}
      className="min-h-screen scroll-mt-16 bg-white dark:bg-zinc-900 px-[5vw] lg:py-20 md:py-16 sm:py-12 py-8 flex flex-col items-center "
    >
